...
Please try using another token or open an issue on https://github.com/mui/mui-x/issues/new/choose if you think it should be supported.` : (0, _formatErrorMessage2.default)(157, formatToken));
  }
...
const doesSectionFormatHaveLeadingZeros = (adapter, contentType, sectionType, format) => {
  ...
  switch (sectionType) {
    ...
    default:
      {
        throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X:Invalid section type' : (0, _formatErrorMessage2.default)(158));
      }
  }
};
