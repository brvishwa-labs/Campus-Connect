...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#f8fafc] overflow-hidden font-sans w-full">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        {/* Top Header */}
        <header className="h-[72px] bg-white border-b border-gray-200 flex items-center justify-between px-8 z-10 flex-shrink-0">
          <div className="flex items-center">
            <div className="flex items-center text-gray-700 font-bold text-[14px] bg-gray-50 px-4 py-2 rounded-xl border border-gray-200 shadow-sm">
              <Home className="w-4 h-4 mr-2 text-gray-400" />
              {pageName}
            </div>
            
            <div className="ml-8 relative hidden lg:block w-96">
